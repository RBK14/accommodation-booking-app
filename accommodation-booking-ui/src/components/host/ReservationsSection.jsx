                                    ...
                                    <CardContent>
                                        <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 2 }}>
                                            <Box>
                                                ...
                                                {/* Szczegóły dla admina */}
                                                {showAdminDetails && (
                                                    <Box sx={{ mb: 1 }}>
                                                        <Typography variant="caption" sx={{ color: 'textSecondary', display: 'block' }}>
                                                            ID rezerwacji: <strong>{reservation.id}</strong>
                                                        </Typography>
                                                        <Typography variant="caption" sx={{ color: 'textSecondary', display: 'block' }}>
                                                            ID gościa: <strong>{reservation.guestProfileId}</strong>
                                                        </Typography>
                                                    </Box>
                                                )}
                                            ...
                                            {/* Status Chip i przycisk zmiany statusu */}
                                            <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: 0.5 }}>
                                                <Chip
                                                    ...
                                                    size="small"
                                                />
                                                {/* Przycisk zmiany statusu (jeśli istnieje) */}
                                                {reservation.statusAction && reservation.statusAction}
                                            </Box>
                                        </Box>
